...
def total_site_attach_counts(from_date):
    ...
    """
    summary_path = UiConfig.get_summary_db_file()
...
def get_summary_list(from_date: str) -> str:
            # a.site_name, a.page_id, b.detail_url, a.org_url,
    sql = """
        SELECT 
            b.h_name as "사이트", 
            b.desc as "페이지", 
...
def attach_list(site_name: str, page_id: str, real_seq: str):
    """
    특정 사이트와 페이지의 첨부파일 목록을 HTML 테이블로 반환합니다.
    """
    query = """
